...
for i=1:10, temp = fgetl(fid); end
Lx = str2num(fgetl(fid));
for i=1:2, temp = fgetl(fid); end
...
if (choicePlot==3) l = 1:jumpTheta:(n_x+1);  end
...
%% save
csvwrite("data.csv",[xx', rho', cos(theta)'])
